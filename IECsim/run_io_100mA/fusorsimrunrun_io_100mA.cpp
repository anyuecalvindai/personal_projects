...
const double beam_current = 0.100;   // 100mA ions
...
// IONS ONLY: electron block disabled
// const double beam_current_e = 10.000; // electrons
// const long N_clouds_e = N_clouds;
// const double IQ_e = beam_current_e / ((double) N_clouds_e);
// const double m_e = 0.000548579909;
...
// add_electrons() removed for ions-only run
...
void sim(int argc, char **argv){
    ...
    // IONS-ONLY: electron plotting block removed.
